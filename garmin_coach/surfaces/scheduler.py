...
from garmin_coach.heartbeat import beat
from garmin_coach.domain.reminders import Reminders, as_utc
from garmin_coach.surfaces.telegram_bot import TelegramCoach
from garmin_coach.surfaces.telegram_sender import send_telegram_message
