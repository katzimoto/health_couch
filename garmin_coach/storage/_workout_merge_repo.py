...
from garmin_coach.storage._db_common import _as_day, synthetic_activity_id
from garmin_coach.storage.models import StrengthSession, Workout, WorkoutSourceLink
from garmin_coach.domain.strength_merge import is_strength_like
...
class WorkoutMergeMixin:
    ...
    def _plan_strength_merge(
        ...
        """
        from garmin_coach.domain.strength_merge import weighted_avg_hr
    ...
    def merge_garmin_strength_fragments(
        ...
        """
        from garmin_coach.domain.strength_merge import group_fragments, is_strength_like
